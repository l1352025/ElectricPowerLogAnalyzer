...
xcopy  %srcPath%\%projName%\bin\Release\7z.exe  %dstPath%\%objName%\ /y /d
xcopy  %srcPath%\%projName%\bin\Release\merge_plccomlog.bat  %dstPath%\%objName%\ /y /d
